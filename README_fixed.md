...
[![GitHub followers](https://img.shields.io/github/followers/1905185430?style=social)](https://github.com/1905185430)
...
![视频演示](https://github.com/1905185430/1905185430/raw/main/videos/pi0.5模型夹取红色方块.mov)
...
![视频演示](https://github.com/1905185430/1905185430/raw/main/videos/pi0.5模型夹取红色方块到绿色方块上方.MOV)
...
```mermaid
graph TD
    A[Robot Learning] --> B[SO-101 Robot Arm]
    A --> C[LeRobot Framework]
    A --> D[VLA Models]
    B --> E[Teleoperation]
    B --> F[Data Collection]
    B --> G[Policy Training]
    ...
    C --> J[Deployment]
    D --> K[SmolVLA]
    D --> L[LoRA Fine-tuning]
    D --> M[Real-time Inference]
```
...
![Visitor Count](https://profile-counter.glitch.me/1905185430/count.svg)
